...
class AmqpConsumer(object):
    ...
    def __init__(self, amqp_url, logger=None):
...
class ReconnectingAmqpConsumer(object):
    """This is an example consumer that will reconnect if the nested
    ExampleConsumer indicates that a reconnect is necessary.
    """

    def __init__(self, amqp_url, consumer=None, logger=None):
...
def main():
    ...
    consumer = ReconnectingAmqpConsumer(amqp_url)
    consumer.run()
